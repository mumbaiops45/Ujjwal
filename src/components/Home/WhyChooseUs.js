      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <p className="text-[var(--accent)]/65 leading-relaxed text-sm max-w-sm">
            Global retail buyers demand zero compromise on quality, consistent print
            accuracy and on-time delivery for every single order. Our clients depend on
            Ujjwal Poly Pack to deliver that, every time.
          </p>
        </div>
